...
#
# build.tcl: Tcl script for re-creating project 'State-Estimation'
#
# Generated by Vivado on Wed Jul 22 15:36:09 -0400 2026
...
set _xil_proj_name_ "State-Estimation"
...
set_property -name "board_part" -value "xilinx.com:kr260_som:part0:2.0" -objects $obj
set_property -name "board_connections" -value "som240_2_connector xilinx.com:kr260_carrier:som240_2_connector:2.0 som240_1_connector xilinx.com:kr260_carrier:som240_1_connector:2.0" -objects $obj
...
# Proc to create BD state_est_bd
proc cr_bd_state_est_bd { parentCell } {

  # CHANGE DESIGN NAME HERE
  set design_name state_est_bd
...
\
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Default View_ScaleFactor":"1.37383",
   "Default View_TopLeft":"-51,-97",
...
# End of cr_bd_state_est_bd()

cr_bd_state_est_bd ""
set_property EXCLUDE_DEBUG_LOGIC "0" [get_files state_est_bd.bd ] 
set_property GENERATE_SYNTH_CHECKPOINT "1" [get_files state_est_bd.bd ] 
set_property IS_ENABLED "1" [get_files state_est_bd.bd ] 
set_property IS_GLOBAL_INCLUDE "0" [get_files state_est_bd.bd ] 
set_property PATH_MODE "RelativeFirst" [get_files state_est_bd.bd ] 
set_property PFM_NAME "" [get_files state_est_bd.bd ] 
set_property REGISTERED_WITH_MANAGER "1" [get_files state_est_bd.bd ] 
set_property SYNTH_CHECKPOINT_MODE "Hierarchical" [get_files state_est_bd.bd ] 
set_property USED_IN "synthesis implementation simulation" [get_files state_est_bd.bd ] 
set_property USED_IN_IMPLEMENTATION "1" [get_files state_est_bd.bd ] 
set_property USED_IN_SIMULATION "1" [get_files state_est_bd.bd ] 
set_property USED_IN_SYNTHESIS "1" [get_files state_est_bd.bd ] 
